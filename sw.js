...
define(['./workbox-52f2a342'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "dccfc49470c04fbd696ce2ac1418eff6"
  }, {
    "url": "config.json",
    "revision": "a4fd54ed44648242cf28b9bfddca2d64"
  }, {
  ...
  workbox.registerRoute(/\.(?:css|js)$/, new workbox.CacheFirst({
    "cacheName": "assets",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 1000,
  ...
  workbox.registerRoute(/\.(?:ttf|woff|woff2)$/, new workbox.CacheFirst({
    "cacheName": "fonts",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 1000,
      maxAgeSeconds: 31536000
